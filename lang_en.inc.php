...
@define('PLUGIN_EVENT_PINIT_NAME',								'Pinit Plugin');
@define('PLUGIN_EVENT_PINIT_DESC',								'Plugin to add Pinterest pinit buttons to s9y images.');
@define('PLUGIN_EVENT_PINIT_PROP_PINIT_ON',       'Enable pinit.' );
